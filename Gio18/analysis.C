...
void analysis () {
   ...
   TH2D *h_energy_time_cal = new TH2D("h_energy_time_cal", "Energy vs Time", 2048., 0., 4096., 3800., 99.5, 7400.);
   ...
   TF1 *gaus3 = new TF1("gaus1", "gaus", 5320., 5440.);
   gaus3->SetParLimits(1, 5410., 5422.);
   TF1 *gaus4 = new TF1("gaus2", "gaus", 5458., 5600.);

   TF1 *total1 = new TF1("total", "gaus(0) + gaus(3)", 5300., 5600.);
